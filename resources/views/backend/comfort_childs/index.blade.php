...
{{--                                                <hr style="margin: 0px;">--}}
{{--                                            @endforeach--}}
                                            <a href="{{route('comfort_childs.create')}}"
