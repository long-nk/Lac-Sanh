            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Quản lý nội dung trang liên hệ</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
...
{{--                                <i class="fa fa-plus"></i> Thêm section cho trang liên hệ--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                        <div class="col-md-2" style="padding: 0px;">--}}
{{--                            <a href="{{route('contact_page.create')}}"--}}
{{--                               class="btn btn-success form-control btnAddNew">--}}
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="15%">Hình ảnh 1</th>
                                    <th class="text-center" width="15%">Hình ảnh 2</th>
                                ...
                                @if(@$contents && count(@$contents) > 0)
                                    @foreach($contents as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img src="{{asset('' . @$value->image2)}}" alt="" style="max-width: 100%;">
                                            </td>
                                            <td class="text-left">
                                                {!! $value->content !!}
                                            </td>
...
{{--                                                                    <a href="{{route('contact_page.edit', $intro->id)}}"--}}
...
{{--                                                                @if(!$intro->default)--}}
{{--                                                                <form--}}
{{--                                                                    action="{{route('contact_page.destroy', $intro->id)}}"--}}
{{--                                                                    method="post">--}}
...
{{--                                                    @endforeach--}}
{{--                                                @endif--}}
{{--                                                <a href="{{route('contact_page.create', ['id' => $value->id])}}"--}}
...
{{--                                            </td>--}}
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('contact_page.edit', $value->id)}}" style="min-width:100px;"
                                                   class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Cập
                                                    nhật</a>
{{--                                                @if(!$value->default)--}}
{{--                                                <form action="{{route('contact_page.destroy', $value->id)}}" method="post">--}}
{{--                                                    <input type="hidden" name="_method" value="DELETE">--}}
{{--                                                    {{csrf_field()}}--}}
...
{{--                                                <form action="{{route('contact_page.update', $value->id)}}"--}}
...
{{--                                        </div>--}}
    ...
    <div id="modalCreateIntroduce" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <form action="{{route('contact_page.store')}}" class="form-horizontal"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Thêm danh mục nội dung trang liên hệ</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-md-4 text-right">
