                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:20%">Link danh mục</th>
                                    <th class="text-center" style="width:20%">Thứ tự hiển thị</th>
                                ...
                                <tbody>
                                @foreach ($categories_admin as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('categories.edit', $value->id)}}"><img
                                                    src="{{asset('images/uploads/categories/' . $value->image)}}"
                                        ...
                                        <td class="text-center">
                                            {{$value->check ? 'Hàng trên' : 'Hàng dưới'}}
                                        </td>
                                        <td class="text-center">
                                            @if($value->status)
...
//            'order': [[3, 'asc']],
    ...
    function ConfirmDelete() {
        var x = confirm("Bạn có muốn xóa danh mục này?");
        if (x)
            return true;
        else
            return false;
