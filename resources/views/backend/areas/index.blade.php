...
@section('title', 'Quản lý khu vực | Dashboard')
@section('content')
    <!-- page content -->
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="25%">Tên khu vực</th>
...
{{--                                        </td>--}}
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('areas.edit', $value->id)}}" style="min-width:100px;"
...
{{--    <script src="{{asset('build/js/custom.js')}}"></script>--}}
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete() {
            var x = confirm("Bạn có muốn xóa khu vực này?");
            if (x)
                return true;
            else
                return false;
