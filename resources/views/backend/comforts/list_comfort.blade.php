...
@section('title', "Danh sách tiện ích chung" . config('app.name'))
        ...
        <div class="">
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Danh sách tiện ích chung</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('comfort_villas.edit', ['type' => $type])}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Cập nhật tiện ích chung
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Danh sách tiện ích chung</h2>
...
{{--                                    <th class="text-center" style="width:10%">Hành động</th>--}}
                                ...
                                <tbody>
                                @foreach ($listComfortAll as $key => $value)
                                    <tr>
