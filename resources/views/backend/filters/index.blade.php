...
@section('title', 'Quản lý bộ lọc | Dashboard')
@section('content')
    <!-- page content -->
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Quản lý bộ lọc</h3>
                    </div>
                </div>
{{--                <div class="row">--}}
{{--                    <div class="col-md-12">--}}
{{--                        <div class="col-md-2" style="padding: 0px;">--}}
{{--                            <a href="{{route('areas.create')}}" class="btn btn-success form-control btnAddNew">--}}
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="25%">Tên bộ lọc</th>
...
{{--                                        </td>--}}
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('filters.edit', $value->id)}}" style="min-width:100px;"
                                               class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Cập nhật</a>
{{--                                            <form action="{{route('areas.destroy', $value->id)}}" method="post">--}}
...
{{--    <script src="{{asset('build/js/custom.js')}}"></script>--}}
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete() {
            var x = confirm("Bạn có muốn xóa bộ lọc này?");
            if (x)
                return true;
            else
                return false;
