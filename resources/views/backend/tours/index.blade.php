...
@section('title', 'Quản lý tour | Dashboard')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('tours.create')}}" class="btn btn-success form-control btnAddNew">
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:10%">Tên tour</th>
                                    <th class="text-center" style="width:15%">Địa chỉ</th>
                                    <th class="text-center" style="width:10%">Giá tour</th>
                                    ...
                                    @foreach (@$tours as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('tours.edit', $value->id)}}">{{$value->name}}</a>
                                            </td>
                                            <td class="text-center">
                                                {{$value->address}}
                                            </td>
...
{{--                                            </td>--}}
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('schedules.index', ['id' => $value->id])}}"
                                                   style="min-width:130px;"
                                                   class="btn btn-success btn-sm"> Quản lý lịch trình</a>
                                                <a href="{{route('tour_hotels.index', ['id' => $value->id])}}"
                                                   style="min-width:130px;"
                                                   class="btn btn-warning btn-sm"> Quản lý khách sạn</a>
                                                <a href="{{route('tours.edit', $value->id)}}" style="min-width:130px;"
                                                   class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Cập
                                                    nhật</a>
                                                <form action="{{route('tours.destroy', $value->id)}}" method="post">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    {{csrf_field()}}
                                                    <button type="submit" onclick="return ConfirmDelete()"
                                                            class="btn btn-danger btn-sm" name="actiondelete" value="1"
                                                            style="min-width:130px;"><i
