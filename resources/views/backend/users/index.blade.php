                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">Phân quyền</th>
                                ...
                                @foreach ($users as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="javascript:void(0)"  >{{$value->name}}</a>
                                        </td>
                                        <td class="text-center" style="font-weight: bold;">{{$value->user_name}}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @elseif($value->role == \App\Models\User::STAFF_ROLE)
                                                <form action="" method="post">
                                                    {{csrf_field()}}
                                            ...
                                            @elseif($value->role == \App\Models\User::USER_ROLE)
                                                <form action="" method="post">
                                                    {{csrf_field()}}
                                                    <input type="hidden" name="status" value="1">
                                                    <button type="submit"
                                                            class="btn btn-round btn-warning btn-xs">
                                                        Cộng tác viên
                                                    </button>
                                                </form>
                                            @elseif($value->role == \App\Models\User::ORDER_ROLE)
                                                <form action="" method="post">
                                                    {{csrf_field()}}
                                                    <input type="hidden" name="status" value="1">
                                                    <button type="submit" class="btn btn-round btn-danger btn-xs">
                                                        Quản lý đơn hàng
                                                    </button>
                                                </form>
                                            @endif
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('users.edit', $value->id)}}" type="button"
                                               class="btn btn-info btn-sm" style="min-width:100px;"><i
