            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-horizontal form-label-left"
                          action="{{route('terms.updateTerm', $content->id)}}" enctype="multipart/form-data"
                          autocomplete="off" method="post">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>{{@$content->parent ? $content->parent->title : 'Chính sách'}}</h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="text">Nội dung bài
                                        viết
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="remove-faq-ajax mb-3" data-question-id="{{ $faq->id }}">
                                                        <div class="faq-box p-3">
                                                            ...
                                                            <input type="text" name="faqs[{{ $index }}][question]"
                                                                   ...
                                                                   value="{{ $faq['name'] ?? '' }}" required>
                                                            <textarea name="faqs[{{ $index }}][answer]"
                                                                      class="form-control textarea-fqas"
                                                                      rows="5" placeholder="Nhập câu trả lời"
                                                                      required>{!! $faq['intro'] ?? '' !!}</textarea>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @endif
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="seo-textarea-wrapper">
                                            ...
                                            <textarea id="meta-description" name="summary"
                                                      ...
                                                      placeholder="Nội dung"
                                                      rows="5"
                                            >{!! strip_tags($content->summary) !!}</textarea>
                                        </div>
