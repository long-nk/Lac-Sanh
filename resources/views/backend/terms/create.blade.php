...
@section('title', 'Thêm bài viết | Dashboard')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left" action="{{route('terms.createTerm')}}"
                                  enctype="multipart/form-data" autocomplete="off" method="post">
                                {{csrf_field()}}
                                {{--                                <input type="hidden" name="parent_id" value="{{@$news}}">--}}
                                <input type="hidden" name="type" value="{{\App\Models\Contents::TERM}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <label class="control-label text-left" for="name">Kết quả<span
                                                        class="required">*</span></label>
                                                <input id="total-vote" class="form-control" type="number" style="color: #ffa118;font-weight: 600;" disabled
                                                       placeholder="Kết quả">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            @foreach ($oldFaqs as $index => $faq)
                                                <div class="faq-item mb-3">
                                                    <div class="faq-box p-3">
                                                        ...
                                                        <input type="text" name="faqs[{{ $index }}][question]" class="form-control mb-2" placeholder="Nhập câu hỏi" value="{{ $faq['question'] ?? '' }}" required>
                                                        <textarea name="faqs[{{ $index }}][answer]" class="form-control textarea-fqas" rows="5" placeholder="Nhập câu trả lời" required>{{ $faq['answer'] ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        <button type="button" class="btn btn-primary mt-2" id="add-faq">Thêm câu hỏi</button>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input id="title" name="title_seo" type="text" class="form-control" value="{{old('title_seo')}}"
                                               required>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slug">URL bài viết <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="seo-info">
                                        ...
                                        <input id="slug" name="slug" type="text" class="form-control" value="{{old('slug')}}"
                                               ...
                                               required>
                                        @if ($errors->has('slug'))
                                            <div class="alert alert-danger"><strong>{{ $errors->first('slug') }}</strong></div>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="seo-textarea-wrapper">
                                            <div class="seo-info">
                                                ...
                                                <div id="seoTitleBarSummary" class="seo-bar" style="display: flex; gap: 4px;">
                                                    <div class="seo-segment" style="height: 8px; flex: 1; background-color: #e0e0e0; opacity: 0.3;"></div>
                                                    <div class="seo-segment" style="height: 8px; flex: 1; background-color: #e0e0e0; opacity: 0.3;"></div>
                                                    <div class="seo-segment" style="height: 8px; flex: 1; background-color: #e0e0e0; opacity: 0.3;"></div>
                                                    <div class="seo-segment" style="height: 8px; flex: 1; background-color: #e0e0e0; opacity: 0.3;"></div>
                                                    <div class="seo-segment" style="height: 8px; flex: 1; background-color: #e0e0e0; opacity: 0.3;"></div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="view" class="form-control col-md-7 col-xs-12"
                                               name="view" type="number" placeholder="Lượt xem">
                                        @if ($errors->has('view'))
                                            <div id="formMessage" class="alert alert-danger">
