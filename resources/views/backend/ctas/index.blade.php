                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('ctas.create')}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Thêm CTA
                            </a>
                        </div>
                    </div>
                </div>
...
{{--                                    <th class="text-center" width="15%">Tên CTA</th>--}}
                                    <th class="text-center" width="15%">Hình ảnh</th>
                                    <th class="text-center" width="15%">Code</th>
                                    <th class="text-center" width="7%">Sắp xếp</th>
...
{{--                                        </td>--}}
                                        ...
                                        <td class="text-center">
                                            {{date('H:i d/m/Y', strtotime(@$value->updated_at))}}
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('ctas.edit', $value->id)}}" style="min-width:100px;"
                                               class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Cập nhật</a>
                                            <form action="{{route('ctas.destroy', $value->id)}}" method="post">
...
//            'order': [[3, 'asc']],
        ...
        function ConfirmDelete() {
            var x = confirm("Bạn có muốn xóa CTA này?");
            if (x)
                return true;
            else
                return false;
