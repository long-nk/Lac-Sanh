        ...
        <div class="">
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Quản lý lịch trình {{@$tour->name}}</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('schedules.create', ['id' => @$tour->id])}}" class="btn btn-success form-control btnAddNew">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Danh sách lịch trình {{@$tour->name}}</h2>
                        ...
                        <div class="x_content">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">Tên lịch trình</th>
                                    <th class="text-center" width="10%">Thông tin</th>
                                ...
                                <tbody>
                                    @foreach($schedules as $k => $schedule)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('schedules.edit', $schedule->id)}}" style="min-width:100px;"
...
//            'order': [[3, 'asc']],
    ...
    function ConfirmDelete() {
        var x = confirm("Bạn có muốn xóa lịch trình này?");
        if (x)
            return true;
        else
            return false;
    ...
    function ConfirmDeleteAttribute() {
        var x = confirm("Bạn có muốn xóa lịch trình được áp cho khách sạn này?");
        if (x)
            return true;
        else
            return false;
