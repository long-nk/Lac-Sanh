...
@section('title', "Yêu cầu đặc biệt | " . config('app.name'))
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Quản lý yêu cầu đặc biệt</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('comfort_specials.create')}}" class="btn btn-success form-control btnAddNew">
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:15%">Tên yêu cầu</th>
                                ...
                                <tbody>
                                @foreach ($listComfortSpecial as $key => $value)
                                    <tr>
...
{{--                                        </td>--}}
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('comfort_specials.edit', $value->id)}}"
                                               class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                            <form action="{{route('comfort_specials.destroy', $value->id)}}" method="post">
                                                <input type="hidden" name="_method" value="DELETE">
                                                {{csrf_field()}}
...
//            'order': [[3, 'asc']],
        ...
        function ConfirmDelete() {
            var x = confirm("Bạn có muốn xóa yêu cầu này?");
            if (x)
                return true;
            else
                return false;
