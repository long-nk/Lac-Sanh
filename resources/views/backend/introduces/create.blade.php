...
@section('title', 'Thêm Nội dung trang | Dashboard')
@push('css')
    <style>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Thông tin nội dung trang</h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left" action="{{route('introduces.store')}}"
...
{{--                                <div class="item form-group">--}}
{{--                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Loại Nội dung trang <span class="required">*</span>--}}
{{--                                    </label>--}}
{{--                                    <div class="col-md-6 col-sm-6 col-xs-12">--}}
...
{{--                                                    Nội dung trang dài:   <span id="seoCharCountContent"> 0 từ </span>--}}
{{--                                                </span>--}}
{{--                                            </div>--}}
...
{{--                                <div class="item form-group mt-4">--}}
{{--                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nội dung trang liên quan</label>--}}
{{--                                    <div class="col-md-6 col-sm-6 col-xs-12">--}}
{{--                                        <div class="faq-item mb-3">--}}
{{--                                            <div class="faq-box p-3">--}}
...
{{--                                <div class="item form-group">--}}
{{--                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slug">URL Nội dung trang--}}
