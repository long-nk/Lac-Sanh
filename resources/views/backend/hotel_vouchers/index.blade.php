                        ...
                        <div class="x_content">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">Mã voucher</th>
                                    <th class="text-center" width="30%">Áp dụng cho</th>
                                    <th class="text-center" width="30%">Phần trăm giảm giá</th>
                                    <th class="text-center" width="30%">Thời hạn áp dụng</th>
                                            ...
                                            <td class="">
                                                @foreach($voucher->hotels as $hotel)
                                                    <div class="box_content" style="border: 1px solid #4054675e;padding: 5px;">
                                                        ...
                                                        <div class="action">
                                                            <a href="{{route('hotel_vouchers.edit', $hotel->id)}}"
                                                               style="min-width:50px;" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Sửa</a>
                                                            <form action="{{route('hotel_vouchers.destroy', $hotel->id)}}"
                                                                  method="post">
                                                    ...
                                                    <hr style="margin: 0px;">
                                                @endforeach
                                                <a href="{{route('hotel_vouchers.create', ['id' => $voucher->id])}}"
