        ...
        <div class="">
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Quản lý khách sạn ở dành cho tour {{@$tour->name}}</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('tour_hotels.create', ['id' => @$tour->id])}}" class="btn btn-success form-control btnAddNew">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Danh sách khách sạn {{@$tour->name}}</h2>
                        ...
                        <div class="x_content">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">Tên khách sạn</th>
                                    <th class="text-center" width="10%">Hình ảnh</th>
                                    <th class="text-center" width="10%">Loại khách sạn</th>
                                ...
                                <tbody>
                                    @foreach($hotels as $k => $hotel)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img src="{{asset('' . $hotel->image)}}" style="max-width: 250px" alt="{{$hotel->name}}">
                                            </td>
                                            <td class="text-center">
                                                {{ $hotel->rate }} sao
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('tour_hotels.edit', $hotel->id)}}" style="min-width:100px;"
                                                   class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                <form action="{{route('tour_hotels.destroy', $hotel->id)}}" method="post">
...
//            'order': [[3, 'asc']],
    ...
    function ConfirmDelete() {
        var x = confirm("Bạn có muốn xóa khách sạn này?");
        if (x)
            return true;
        else
            return false;
    ...
    function ConfirmDeleteAttribute() {
        var x = confirm("Bạn có muốn xóa khách sạn được áp cho khách sạn này?");
        if (x)
            return true;
        else
            return false;
