...
@section('title', 'Cập nhật FAQs | Dashboard')
@section('content')
                    ...
                    <form class="form-horizontal form-label-left"
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_department">
                                ...
                                @if(!empty($listQuestionContent) && count($listQuestionContent) > 0)
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" multiple="multiple" name="list_content[]"
                                                ...
                                                @foreach($listQuestionContent as $content)
                                                    <option
                                                        value="{{$content->id}}" {{ in_array($content->id, $question_contents)? 'selected' : ''}}>{{$content->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="name" value="{{$question->name}}"
                                ...
                                {{--                                            <img src="{{asset('' . @$question->image)}}" alt="" id="img_show">--}}
                                {{--                                            <i class="">+</i>--}}
                                {{--                                        </div>--}}
                                ...
                                {{--                                </div>--}}
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Trả lời <span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea name="intro" id="editor1" value="{{old('intro')}}"
                                                      class="form-control editor2" cols="30" rows="30"
                                                      placeholder="Nội dung">{!! $question->intro !!}</textarea>
                                        @if ($errors->has('intro'))
                                            <div id="formMessage" class="alert alert-danger">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="sort" value="{{$question->sort}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <select name="status" id="status"
                                            ...
                                            <option value="1" {{$question->status==1?"selected":""}}>Hiển thị</option>
                                            <option value="0" {{$question->status==0?"selected":""}}>Không hiển thị
                                            </option>
                                        </select>
                                    </div>
                                </div>
...
@push('js')
    ...
    <script>
        ...
        $("#content-list").val(@json(@$question_contents)).change();
    </script>
    <script>
