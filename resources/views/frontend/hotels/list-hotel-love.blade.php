    ...
    <main>
        ...
        <section class="page-account">
            <div class="container">
                {{--                <ul class="nav">--}}
                {{--                    <li class="nav-items">--}}
                {{--                        <a class="nav-link active" data-bs-toggle="tab" href="#quanlytk" title="">Quản lý tài khoản </a>--}}
                {{--                    </li>--}}
                {{--                    <li class="nav-items">--}}
                ...
                <div class="tab-content">
                    ...
                    {{--                        </div>--}}
                    {{--                    </div>--}}
                    <div class="tab-pane fade active show" id="kslike">
                        <div class="tab-container">
                            ...
                            @if(count(@$favoristList) > 0)
                                @foreach($favoristList as $hotel)
                                                    ...
                                                    @if((count(@$hotel->comments)) != 0)
                                                        <div class="dg">
                                                            ...
                                                            <a class="js-dg" data-bs-toggle="modal"
                                                               data-bs-target="#modal-danhgia-{{$hotel->id}}"
                                    ...
                                    <div class="modal fade" id="modal-danhgia-{{$hotel->id}}" tabindex="-1"
                                         role="dialog"
                                    ...
                                    <span class="select-sx--title">Sắp xếp: <span
                                            class="js-sx">Mới nhất</span></span>
                                                                    <div class="select-filter-model filter-model"
                                                                         id="filter-select-3">
                                                                        <label class="js-dots active">
                                                                            <span class="dots"></span>
                                                                            <span class="text">Mới nhất</span>
                                                                            <input type="radio" name="cc" value="new"
                                                                                   class="filter-select"
                                                                                   data-hotel="{{@$hotel->id}}"
                                                                                   data-type="{{@$type}}">
                                                                        </label>
                                                                        <label class="js-dots">
                                                                            ...
                                                                            <input type="radio" name="cc" value="old"
                                                                                   class="filter-select"
                                                                                   data-hotel="{{@$hotel->id}}"
                                                                                   data-type="{{@$type}}">
                                                                        </label>
                                                                        <label class="js-dots">
                                                                            ...
                                                                            <input type="radio" name="cc" value="max"
                                                                                   class="filter-select"
                                                                                   data-hotel="{{@$hotel->id}}"
                                                                                   data-type="{{@$type}}">
                                                                        </label>
                                                                        <label class="js-dots">
                                                                            ...
                                                                            <input type="radio" name="cc" value="min"
                                                                                   class="filter-select"
                                                                                   data-hotel="{{@$hotel->id}}"
                                                                                   data-type="{{@$type}}">
                                                                        </label>
                                                                ...
                                                                <div class="details-raiting--content"
                                                                     id="list-result-filter-{{$hotel->id}}" style="overflow-y: hidden;">
                                                                    @if(count($hotel->comments) > 0)
                                                                        @foreach($hotel->comments as $comment)
                                                                            <div class="items">
                                                                                <div class="row">
