...
<header class="header">
            ...
            <div class="col-md-3">
                <div class="header--logo">
                    <a href="{{route("home")}}" title="Logo Viva Trip">
                        <img src="{{asset('' . $pageInfo->logo)}}" width="150px" height="42px" alt="Logo Vivatrip">
                    </a>
    ...
    <div class="js-show-mobile">
        <img src="{{asset('assets/images/menu_black.png')}}" alt="Menu icon" class="account-menu-header">
    </div>
    @if($customer != null)
        <div class="js-show-user" ><a href="{{route('customers.index')}}">
                <img src="{{asset('assets/images/account_black.png')}}" alt="Account icon" class="account-icon-header">
        </div>
    @else
        <div class="js-show-user" data-bs-toggle="modal" data-bs-target="#modalLogin">
            <img src="{{asset('assets/images/account_black.png')}}" alt="Account icon" class="account-icon-header">
        </div>
    @endif
</header>
