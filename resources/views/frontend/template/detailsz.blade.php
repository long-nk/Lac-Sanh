							...
							<div class="tab-pane fade active show" id="bancong">
								<div class="tab-pane--album">
									<div class="img-top ratio">
										<img class="js-add-url" src="{{asset('assets/images/z1.png')}}" alt="">
									</div>
									<div class="img-b">
										<?php for($i=1; $i<5; $i++){ ?>
										<div class="img ratio js-img-pp">
											<img src="{{asset('assets/images/z1.png')}}" alt="">
										</div>
										<div class="img ratio js-img-pp">
					...
					<div class="col-lg-5">
						<div class="infor-room">
							<div class="infor-room--custom">
								...
								<span>
									<img src="{{asset('assets/images/m2.png')}}" alt="">
									55m<up>2</up>
								</span>
								<span>
									<img src="{{asset('assets/images/giuong2.png')}}" alt="">
									2 giường đơn
								</span>
							</div>
