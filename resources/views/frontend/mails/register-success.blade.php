                ...
                <tr>
                    <td align="center">
                        <img src="{{ asset('images/logo.png') }}" alt="Logo top"
                             style="max-width:100%; height:auto;margin-top: 25px">
                    </td>
                </tr>
...
{{--                        <img src="{{ asset('images/success.png') }}" alt="Image success"--}}
                ...
                <tr>
                    <td style="padding-bottom: 30px; padding-left: 30px; padding-right: 30px; padding-top: 0px; color:#1e1e1e; font-family: 'Montserrat', Arial, sans-serif; font-size:16px; line-height:1.6;">
                        <h1 style="margin-bottom:10px;  text-align:center; font-size:22px; color:#1e1e1e; font-weight:700;">
                            Kích hoạt tài khoản để sử dụng!</h1>
                        <p style="margin: 0px; text-align:center; color:#1e1e1e; font-size:16px; font-family: 'Montserrat', Arial, sans-serif; font-style:normal;">
                            Vui lòng click kích hoạt tải khoản bên dưới</p>
...
{{--                                        style="color:#1e1e1e !important; font-weight:700;">{{ @$data['email'] }}</strong>--}}
{{--                                </li>--}}
{{--                                @if($data['password'])--}}
{{--                                    <li style="margin: 12px 0px; color:#1e1e1e; font-weight:400; font-size:16px; font-family: 'Montserrat', Arial, sans-serif; font-style:normal;">--}}
{{--                                        Mật khẩu: <strong--}}
{{--                                            style="color:#1e1e1e; font-weight:700;">{!! @$data['password'] !!}</strong>--}}
{{--                                    </li>--}}
{{--                                @endif--}}
{{--                            </ul>--}}
{{--                        </div>--}}
...
{{--                        <!-- Button -->--}}
                        <div style="text-align:center; margin-bottom:30px;">
                            <a href="{{route('customers.activeAccount', ['email' => @$data['email']])}}"
                               style="background: var(--L2, linear-gradient(90deg, #1a3a75 0%, #526b97 100%)); color:#ffffff; padding:10px 45px; text-decoration:none; font-size:16px; font-weight: 600; border-radius:8px; display:inline-block;">
                                Kích hoạt tài khoản
                            </a>
                        </div>

{{--                        <p style="margin: 0px; color:#1e1e1e; font-size:16px; font-family: 'Montserrat', Arial, sans-serif; font-style:normal;">--}}
{{--                            Trân trọng,<br>{{ $pageInfo->name }}</p>--}}
                    </td>
                </tr>
