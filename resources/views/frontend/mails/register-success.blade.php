                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="text-align:center!important;margin-bottom:10px;color:black; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Vui lòng click đường link bên dưới để kích hoạt tài khoản.</p>
                                    <p align="center"><a style="padding: 8px 10px;background: #00375A;color: #fff;text-decoration: none;font-size: 15px;font-weight: bold;" href="{{route('customers.activeAccount', ['email' => @$data['email']])}}">Kích hoạt</a></p>
                                </td>
                            </tr>
