...
<body style="background-color:#2d3748; font-family:Arial, sans-serif; margin:0; padding:0;">
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:6px; overflow:hidden;">
                ...
                <tr>
                    <td style="padding:20px;font-size:16px; line-height:1.6;">
                        ...
                        <p style="margin: 0px; color:#1e1e1e; font-size:16px; font-family: 'Montserrat', Arial, sans-serif; font-style:normal;">Cảm ơn bạn đã đăng ký tài khoản tại {{$pageInfo->name}}</p><br/>
                        <p style="margin: 0px; color:#1e1e1e; font-size:16px; font-family: 'Montserrat', Arial, sans-serif; font-style:normal;">Để hoàn tất quá trình đăng ký, vui lòng sử dụng mã xác nhận dưới đây:</p>
