...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../{{route('home')}}l"><<< back to documentation</a>'))
...
function writeVersion() {
  return gulp.src(['{{route('home')}}l', 'doc/download.html', 'README.md'], { base: "./" })
