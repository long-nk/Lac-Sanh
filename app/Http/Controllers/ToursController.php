...
class ToursController extends Controller
{
    public function list()
    {
        try {
            ...
            $locationHots = Locations::where('status', 1)
                ...
                ->where('region', Locations::REGION_OUT)
                ->orderBy('sort', 'asc')
                ->get();
            return view('frontend.tours.index', compact('vouchers', 'tourIns', 'tourOuts', 'locationHots'));
        } catch (\Exception $e) {
    ...
    public function search(Request $request)
    {
        try {
            ...
            return view('frontend.tours.list', compact('hotels', 'hotel', 'location', 'title', 'type',
    ...
    public function viewMore(Request $request)
    {
        ...
        return view('frontend.tours.list', compact('hotels', 'type', 'title', 'listComfortHotel'));
    }
    ...
    public function listLocation(Request $request)
    {
        ...
        return view('frontend.tours.list', compact('hotels', 'title', 'location', 'type', 'listComfortHotel', 'listComfortSpecial'));
    }
    ...
    public function filterHotels(Request $request)
    {
        ...
        $queryParams = $request->query();
//        if ($request->ajax()) {
        return view('frontend.tours.list-filter-by', compact('hotels', 'queryParams'))->render();
//        }
    }
...
//        }
        ...
        return view('frontend.tours.list-filter-by', compact('hotels'));
    ...
    public function filter(Request $request)
    {
        ...
        return view('frontend.tours.list-filter', compact('hotels', 'type', 'sliders'));
    }
    ...
    public function filterPriceHots(Request $request)
    {
        ...
        return view('frontend.tours.list-filter-by-price', compact('hotels', 'type'));
    }
    ...
    public function filterPopular(Request $request)
    {
        ...
        return view('frontend.tours.list-filter-slide', compact('hotels', 'type'));
    }
    ...
    public function filterLocation(Request $request)
    {
        ...
        return view('frontend.tours.list-filter-location', compact('hotels', 'type', 'location'));
    }
    ...
    public function listFlashSale(Request $request)
    {
        ...
        return view('frontend.tours.list-flash-sale', compact('hotels', 'listVoucher', 'listLocation', 'sliders'));
    }
    ...
    public function listHotelLove()
    {
        ...
        return view('frontend.tours.list-hotel-love', compact('user', 'favoristList'));
    }
    ...
    public function filterFlashSale(Request $request)
    {
        ...
        return view('frontend.tours.list-filter-flash-sale', compact('hotels'));
    }
    ...
    public function addCompareList(Request $request)
    {
        ...
        if ($room) {
            ...
            return view('frontend.tours.list-compare', compact('listCompare'));
        }
...
//        $listComfort = Comforts::whereRaw("MATCH(name) AGAINST(? IN BOOLEAN MODE)", [$keyword])->get();
        ...
        return view('frontend.tours.list-comfort', compact('listComfortFilter'));
    }
}
