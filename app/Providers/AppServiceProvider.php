...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        view()->composer('*', function ($view) {
            ...
            $terms = Contents::where('type', Contents::CHINH_SACH)->get();
            ...
            $view->with('hotel_categories', $hotel_categories);
            $view->with('hotelCategories', $hotelCategories);
            $view->with('villa_categories', $villa_categories);
            $view->with('villaCategories', $villaCategories);
            $view->with('homestay_categories', $homestay_categories);
            $view->with('homestayCategories', $homestayCategories);
            $view->with('resort_categories', $resort_categories);
            $view->with('resortCategories', $resortCategories);
            $view->with('yacht_categories', $yacht_categories);
            $view->with('yachtCategories', $yachtCategories);
            $view->with('locations', $locations);
            $view->with('locationFooter', $locationFooter);
            $view->with('comforts', $comforts);
            $view->with('listComfort', $listComfort);
        });
    }
